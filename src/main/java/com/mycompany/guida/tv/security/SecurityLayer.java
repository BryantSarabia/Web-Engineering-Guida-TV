...
public class SecurityLayer {
    ...
    public static void generateVerificationLink(String file_path, Utente utente){    
        try {    
            ...
            if(file.createNewFile()) System.out.println("Verification File created"); else System.out.println("Failed creating new file or file already exists");
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(file_path))) {
                ...
                String encrypted_email = URLEncoder.encode(SecurityLayer.encrypt(utente.getEmail(), STATIC_KEY), "UTF-8");
                String text = "";
