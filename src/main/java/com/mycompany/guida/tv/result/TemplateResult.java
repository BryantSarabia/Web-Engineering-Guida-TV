 ...
 * 
 */
package com.mycompany.guida.tv.result;
...
public class TemplateResult {
    ...
    private void init() {
        ...
        if (context.getInitParameter("view.model_filler") != null) {
            try {
                filler = (DataModelFiller) Class.forName(context.getInitParameter("view.model_filler")).getDeclaredConstructor().newInstance();
