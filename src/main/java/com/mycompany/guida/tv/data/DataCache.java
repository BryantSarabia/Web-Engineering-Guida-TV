...
public class DataCache {
    ...
    /**
     * Qualsiasi oggetto del model (cioè che estende DataItem) puo essere
     * contenuto nella mappa. Se la cache non contiene l'oggetto creo la mappa
     * cache come <Classe, mappa>. Altrimenti se la cache contiene la classe
     * aggiungo l'oggetto, mi prendo la coppia corrispondente <Classe, mappa> e
     * aggiungo alla mappa l'oggetto del tipo <id, obj>.
     *
     * @param <C>
     * @param c
     * @param o
    ...
    /**
     * Rimuove un oggetto del model dalla mappa. Controllo se la mappa contiene
     * quell'oggetto. Se lo contiene lo rimuovo
     *
     * @param <C>
     * @param c
     * @param o
    ...
    /**
     * Controllo se la mappa ha un oggetto di di Class c con chiave key e se sì
     * lo elimino.
     *
     * @param c
     * @param key
    ...
    /**
     * Controllo se la mappa contiene un oggetto di tipo c con chiave key. Se si
     * restituisco l'oggetto, altrimenti torno null.
     *
     * @param <C>
     * @param c
     * @param key
